...
macOS menu bar utility that displays an orange overlay on Calendar.app when the app's timezone differs from a configured team timezone. Single-window SwiftUI app with AppKit overlay management. Deployment target: macOS26
